...
| **Trailing base rate** | 0.1204 | baseline | 0.4067 | 0.540 | 0.031 |
...
(`results/metrics.json` has the full grid: every L at both cutoffs, all eight models.)
